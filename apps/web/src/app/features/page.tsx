    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'Rotating QR code refreshes every 15 seconds — screenshot fraud proof',
      ...
      },
      {
        ...
        bullets: [
          'Invite resellers directly via WhatsApp — no open applications',
          'Resellers buy a discounted ticket block upfront and pay cash — zero risk to the organizer',
          'Resellers sell at their own price and keep the markup as their profit',
          'Per-reseller breakdown: tickets bought, cash collected, event assigned',
          'Reseller dashboard: inventory, sales history, and events they can sell',
          'Sell tickets to walk-up customers directly from the reseller app',
          'Revenue page shows online sales vs. reseller cash side by side',
        ],
      },
      {
        icon: '👥',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Platform fee rate admin-adjustable per event',
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'Kòd QR ap chanje chak 15 segond — pa ka pran foto pou fwòd',
      ...
      {
        icon: '🏪',
        title: 'Jestyon Revandè',
        bullets: [
          'Envite revandè dirèkteman pa WhatsApp — pa gen aplikasyon ouvè',
          'Revandè achte yon blòk tikè rabè davans epi peye kach — zewo risk pou òganizatè',
          'Revandè vann nan pwòp pri yo epi kenbe benefis la',
          'Rezime pa revandè: tikè achte, kach kolekte, evènman asiyen',
          'Tablo de bò revandè: envantè, istwa vant, evènman yo ka vann',
          'Vann tikè bay kliyan k ap vini dirèkteman depi aplikasyon revandè a',
          'Paj revni montre vant anliy ak kach revandè bò pa bò',
        ],
      },
      {
        icon: '👥',
      ...
      },
      {
        ...
        bullets: [
          ...
          'To frè platfòm ajistab pa evènman depi tablo admin',
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'QR code rotatif — se renouvelle toutes les 15 secondes pour éviter les fraudes par capture d\'écran',
      ...
      },
      {
        ...
        bullets: [
          'Invitez les revendeurs directement via WhatsApp — sans candidatures ouvertes',
          'Les revendeurs achètent un bloc de billets à prix réduit et paient cash à l\'avance — zéro risque pour l\'organisateur',
          'Les revendeurs vendent au prix qu\'ils souhaitent et gardent la marge comme bénéfice',
          'Récapitulatif par revendeur : billets achetés, cash encaissé, événement assigné',
          'Tableau de bord revendeur : inventaire, historique des ventes, événements disponibles',
          'Vente de billets aux clients au guichet directement depuis l\'app revendeur',
          'La page revenus affiche ventes en ligne et cash revendeurs côte à côte',
        ],
      },
      {
        icon: '👥',
      ...
      },
      {
        ...
        bullets: [
          ...
          'Taux de commission plateforme ajustable par événement depuis l\'admin',
